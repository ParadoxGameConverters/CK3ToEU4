...
class Culture: commonItems::parser
{
  public:
	...
	[[nodiscard]] const auto& getBaseName() const { return baseName; }
  ...
  private:
	...
	std::optional<std::string> baseName;			// if we manage to reverse-map a loc to base we can have "austrian" or "venetian".
