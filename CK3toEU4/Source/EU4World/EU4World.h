...
class World
{
  ...
  private:
	...
	void outputReligions(const Configuration& theConfiguration, std::vector<GeneratedReligion> generatedReligions) const;
	void outputReligionIcons(const Configuration& theConfiguration, std::vector<GeneratedReligion> generatedReligions) const;
